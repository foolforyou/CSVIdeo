...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        UIView *topBgView = [[UIView alloc] initWithFrame:CGRectMake(0, 20, size.width, 44)];
        topBgView.backgroundColor = [UIColor clearColor];
        topBgView.tag = cstopBgViewTag;
        ...
        playBtn.frame = CGRectMake(10, 15, 35, 35);
        ...
        CGRect progressSliderRect = CGRectMake(0, 0, size.width, 15);
        ...
        scaleBtn.layer.borderWidth = 1.0;
        ...
        episodeBtn.layer.borderWidth = 1.0;
        episodeBtn.titleLabel.font = [UIFont boldSystemFontOfSize:15];
        [episodeBtn setTitle:@"推荐" forState:UIControlStateNormal];
        ...
        CGRect fullBtnRect = CGRectMake(size.width - 40, 15, 30, 25);
        ...
        UIImageView *voiceImgView1 = [[UIImageView alloc] initWithFrame:voiceImgViewRect1];
        UIImage *voiceMinImg = [[ThemeManager sharedInstance] imageInCurThemeWithName:@"voice_min"];
        voiceImgView1.image = voiceMinImg;
        [voiceView addSubview:voiceImgView1];
        ...
        UIView *toolView = [[UIView alloc] initWithFrame:toolViewRect];
        ...
        backBtn.titleEdgeInsets = UIEdgeInsetsMake(10, -45, 10, 0);
        ...
        CGRect snapBtnRect = CGRectMake(size.width - 40, (kTopBarHeight - 22) / 2, 22, 22);
...
- (void)updateSubviewsLocation {
    ...
    if (size.height == screenSize.height / 2) {
        ...
        voiceBarView.center = CGPointMake(screenSize.height - 40, (screenSize.width - voiceBarViewSize.width) / 2);
...
- (void)updateBarView {
    ...
    CGRect sliderRect = CGRectMake(0, 0, size.width, 12);
    CGRect startLabelRect = CGRectMake(45, 25, 55, 15);
    CGRect endLabelRect = CGRectMake(45 + 55, 25, 55, 15);
